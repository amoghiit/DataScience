...
plot(ages)#if nothing then it considers index (1,2,3...) and by default ages goes to y axis

salary = c(21000,30000,40000,22000,45000,50000,51000,23000,25000,35000)
plot(salary)

plot(ages,salary)#ages goes to x and salary goes to y axis
plot(salary,ages)
...
data()
airquality = datasets::airquality #it will directly load the airquality datasets
...
plot(airquality$Temp,airquality$Wind,type="p") #type="p" this is optional by default it will take p
...
barplot(airquality$Ozone, 
        ...
        ylab = 'ozone levels', 
        col= 'blue',
        horiz=T,#the bar plot displays is horizontal 
        axes=T)#name of the axes
help(barplot)
